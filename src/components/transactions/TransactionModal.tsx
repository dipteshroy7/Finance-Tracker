...
export default function TransactionModal() {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => !open && closeModal()}>
            <DialogContent
                className="sm:max-w-md p-0 overflow-hidden h-[100dvh] sm:h-[90vh] w-full sm:w-auto max-w-none sm:rounded-2xl border border-border/30 gradient-surface text-text dark:text-text-dark"
