    ...
    return (
        <div className="flex min-h-screen gradient-surface text-text dark:text-text-dark">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                {/* Sync status bar */}
                <div className="flex items-center justify-between px-4 py-1.5 text-xs border-b border-border/30 dark:border-border-dark/30 bg-surface/20 dark:bg-surface-dark/20">
